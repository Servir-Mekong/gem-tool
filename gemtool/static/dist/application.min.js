(function () {
	...
	var app = angular.module('baseApp', ['rzModule','mgcrea.ngStrap', 'ngDialog','ngFileSaver', 'angularSpinner', 'pascalprecht.translate'], ["$interpolateProvider", function ($interpolateProvider) {
...
angular.module('baseApp')
	.controller('downloadcontroller' ,["$scope", "$timeout", "APIService", function ($scope, $timeout, APIService) {
	...
	'use strict';
	angular.module('baseApp')
	.controller('downloaddatasetcontroller' ,["$scope", "$timeout", "APIService", function ($scope, $timeout, APIService) {
	...
	'use strict';
	angular.module('baseApp')
	.controller('homecontroller' ,["$scope", "$timeout", "APIService", function ($scope, $timeout, APIService) {
		...
		mapboxgl.accessToken = 'pk.eyJ1IjoidGhhbm5hcm90IiwiYSI6ImNrOXFzZjgzcjA2OTczZXFrbXV4Z3lzejUifQ.4CmrqCen0XTYYYCjcWGrzg';
			...
			var col_chart_data = [];
			var counties = ['250', '228', '154'];
			var focus_year = 2020;


			
			$scope.getGiiDimensionGroup = function(area_id) {
				var params= {
					area_id: area_id,
					admin_level: admin_level,
					year: focus_year
				...
				.then(function (result){
					...
					switch(area_id) {
						case '228':
							$scope.dimensionGroup_thailand = result;
						  break;
						case '250':
							$scope.dimensionGroup_vietnam = result;
						  break;
						case '154':
							$scope.dimensionGroup_myanmar = result;
						break;
						case '40':
							$scope.dimensionGroup_cambodia = result;
							break;
						case '123':
							$scope.dimensionGroup_laos = result;
							break;
						default:
			...
			$scope.getGiiDimensionData = function(area_id) {
				var params= {
					area_id: area_id,
					admin_level: admin_level,
					year: focus_year
				...
				.then(function (result){
					...
					switch(area_id) {
						case '228':
							$scope.dimensionData_thailand = result;
						  break;
						case '250':
							$scope.dimensionData_vietnam = result;
						  break;
						case '154':
							$scope.dimensionData_myanmar = result;
						break;
						case '040':
							$scope.dimensionData_cambodia = result;
							break;
						case '123':
							$scope.dimensionData_laos = result;
							break;
						default:
			...
			$scope.getGiiIndicatorData= function(area_id) {
				var params= {
					area_id: area_id,
					admin_level: admin_level,
					year: focus_year
				...
				.then(function (result){
					...
					switch(area_id) {
						case '228':
							$scope.indicatorData_thailand = result;
						  break;
						case '250':
							$scope.indicatorData_vietnam = result;
						  break;
						case '154':
							$scope.indicatorData_myanmar = result;
						break;
						case '040':
							$scope.indicatorData_cambodia = result;
							break;
						case '123':
							$scope.indicatorData_laos = result;
							break;
						default:
			...
			$scope.getGiiIndicatorGroup= function(area_id) {
				var params= {
					area_id: area_id,
					admin_level: admin_level,
					year: focus_year
				...
				.then(function (result){
					...
					switch(area_id) {
						case '228':
							$scope.indicatorGroup_thailand = result;
						  break;
						case '250':
							$scope.indicatorGroup_vietnam = result;
						  break;
						case '154':
							$scope.indicatorGroup_myanmar = result;
						break;
						case '040':
							$scope.indicatorGroup_cambodia = result;
							break;
						case '123':
							$scope.indicatorGroup_laos = result;
							break;
						default:
			...
			for (var i = 0; i < counties.length; i++) {
				$scope.getGiiIndicatorData(counties[i]);
				$scope.getGiiDimensionData(counties[i]);
				$scope.getGiiDimensionGroup(counties[i]);
				$scope.getGiiIndicatorGroup(counties[i]);
				
			} 

            $scope.clearValues = function() {

				$('#reproductive_female').css('width', '0%').attr('aria-valuenow', 0).text(''); 
				$('#reproductive_male').css('width', '0%').attr('aria-valuenow', 0).text(''); 

				$('#empowerment_female').css('width', '0%').attr('aria-valuenow',0).text(''); 
				$('#empowerment_male').css('width', '0%').attr('aria-valuenow', 0).text(''); 

				$('#labour_female').css('width', '0%').attr('aria-valuenow', 0).text(''); 
				$('#labour_male').css('width', '0%').attr('aria-valuenow', 0).text(''); 

				$('#education_female').css('width', '0%').attr('aria-valuenow', 0).text(''); 
				$('#education_male').css('width', '0%').attr('aria-valuenow', 0).text(''); 

				$('#idc_reproductive_maternal_mortality').text(''); 
				$('#idc_reproductive_adolescent_fertility').text(''); 

				$('#idc_empower_parliamentary_seats_female').text(''); 
				$('#idc_empower_parliamentary_seats_male').text(''); 

				$('#idc_empower_peoples_council_seats_female').text(''); 
				$('#idc_empower_peoples_council_seats_male').text(''); 

				$('#idc_empower_government_staff_female').text(''); 
				$('#idc_empower_government_staff_male').text(''); 

				$('#idc_labour_force_female').text(''); 
				$('#idc_labour_force_male').text(''); 

				$('#idc_education_primary_school_female').text(''); 
				$('#idc_education_primary_school_male').text(''); 

				$('#idc_education_secondary_school_female').text(''); 
				$('#idc_education_secondary_school_male').text(''); 

				$('#idc_education_literacy_rate_female').text(''); 
				$('#idc_education_literacy_rate_male').text(''); 
			...
			**/
			...
			$scope.getGIIMap = function () {
				...
				.then(function (result){
                    ...
                    var features = result[0].features;
					$scope.mekongGII = features;

					$scope.data_year = features[0]["properties"]["year"];
					var data_key = '';
					data_key = selected_data;

                    //data_key = selected_data+"_"+by_gender;
					for(var i=0; i<features.length; i++){
                        ...
                        if(features[i]["properties"][data_key] < 0.20){
                            features[i]["properties"]["color"] = '#FFFFCD';
                        }else if(features[i]["properties"][data_key] < 0.40){
                            features[i]["properties"]["color"] = '#8ADCE8';
                        }else if(features[i]["properties"][data_key] < 0.60){
                            features[i]["properties"]["color"] = '#2EC4DA';
                        }else if(features[i]["properties"][data_key] < 0.80){
                            features[i]["properties"]["color"] = '#0D899E';
                        }else if(features[i]["properties"][data_key] <= 1.00){
					...
					Highcharts.chart('col-chart-container', {
						...
						xAxis: {
							categories: col_chart_categories,
						},
						
						tooltip: {
							headerFormat: '<span style="font-size:11px">Gender Inquality Index</span><br>',
                    ...
                    $("#legend").html("");
					$("#legend").html("<lable>GII Index</lable>");
					// create legend
					for (i = 0; i < legend_label.length; i++) {
						...
						map.on('mousemove', 'admin_gii', function (e) {
							...
							if (e.features.length > 0) {
								...
								var popup_text = '<h4 style="color:#000540;">'+
								feature.properties.area_name + '</h4><hr>' + 
									...
									function (memo, feature) {
										if(selected_features.includes(feature.properties.area_id)){
											...
											if (index !== -1) {
												...
												$("#gii-"+feature.properties.area_id).css("display", "none");
											}
										}else{
											memo.push(feature.properties.area_id);
											$("#gii-"+feature.properties.area_id).css("display", "flex");
										}
	...
	'use strict';
	angular.module('baseApp')
	.controller('map2controller' ,["$scope", "$timeout", "APIService", function ($scope, $timeout, APIService) {
		...
		mapboxgl.accessToken = 'pk.eyJ1IjoidGhhbm5hcm90IiwiYSI6ImNrOXFzZjgzcjA2OTczZXFrbXV4Z3lzejUifQ.4CmrqCen0XTYYYCjcWGrzg';
					...
					for (var i = 0; i < dataset_l1.length; i++) {
						...
						for (var j = 0; j < dataset_l2.length; j++) {
							...
							if(dataset_l1[i]["dataset_id_l1"] === dataset_l2[j]["dataset_id_l1"]){
								...
								// optgroup += "<option data-content='"+dataset_l2[j]["dataset_name_l2"]+"' data-dataset_id_l1='"+dataset_l1[i]["dataset_id_l1"]+"' data-dataset_name_l1='"+dataset_l1[i]["dataset_name_l1"]+"'  data-by_gender='"+dataset_l2[j]["data"]+"' value='" + dataset_l2[j]["dataset_id"] + "'>" + dataset_l1[i]["dataset_name_l1"] +" - "+ dataset_l2[j]["dataset_name_l2"]+': '+dataset_l2[j]["data"] + "</option>";
							}
			...
			$scope.check_data = function () {
				// $("#by_gender_gap").css("display", "none");
				// $("#by_gender_male").css("display", "none");
				// $("#by_gender_female").css("display", "none");
				// $("#by_gender_gap").attr("disabled", true);
				// $("#by_gender_male").attr("disabled", true);
				// $("#by_gender_female").attr("disabled", true);
				// jqvery
			...
			$scope.getMap = function () {
				...
				$scope.giiData = [];
				// by_gender = 'female';
				// dataset_id = $scope.find_dataset_id_l2();
				...
				.then(function (result){
					...
					if(features.length === 0){
						...
						//data_key = selected_data+"_"+by_gender;
						for(var i=0; i<features.length; i++){
							// col_chart_data.push([features[i].properties.area_name, features[i].properties.value]);
							indicator_data.push(features[i].properties.value);
							// indices_male_data.push(features[i].properties.value);
				...
				.then(function (result){
					...
					if(f_features.length === 0){
						...
						for(var i=0; i<f_features.length; i++){
							// col_chart_data.push([features[i].properties.area_name, f_features[i].properties.value]);
							...
							if(m_features.length === 0){
								...
								if(m_features[0].properties.calc === 'GPI' || m_features[0].properties.calc === 'Ratio' || m_features[0].properties.calc === 'Both'){
									...
									for(var i=0; i<m_features.length; i++){
										...
										// col_chart_data.push([features[i].properties.area_name, m_features[i].properties.value]);
										m_indicator_data.push(m_features[i].properties.value);
										// indices_male_data.push(m_features[i].properties.value);
										m_indices_areas_data.push(m_features[i].properties.area_name);
										// data_unit = m_features[i].properties.unit;
										data_unit = 'GPI';
	...
	'use strict';
	angular.module('baseApp')
	.controller('mapcontroller' ,["$scope", "$timeout", "APIService", function ($scope, $timeout, APIService) {
		...
		mapboxgl.accessToken = 'pk.eyJ1IjoidGhhbm5hcm90IiwiYSI6ImNrOXFzZjgzcjA2OTczZXFrbXV4Z3lzejUifQ.4CmrqCen0XTYYYCjcWGrzg';
			...
			$scope.check_dimension_data = function () {
				// $("#by_gender_index").css("display", "none");
				// $("#by_gender_male").css("display", "none");
				// $("#by_gender_female").css("display", "none");
				// $("#by_gender_ratio").css("display", "none");
			...
			$scope.updateData = function () {
				...
				if(dimension_val === 'gii'){
					...
					// var chart_categories = ['Empowerment', 'Labour Force', 'Reproductive health'];
					// $scope.genSpiderChart("Male", year , chart_categories, chart_spider_series_male, 'spider-male-container');
					// $scope.genSpiderChart("Female", year , chart_categories, chart_spider_series_female, 'spider-female-container');
			...
			$("#gii_dimension_dropdown").change(function(){
				...
				if(selected === 'gii'){
					...
					// $("#by_gender_male").removeClass("active");
					// $("#by_gender_index").removeClass("active");
					// $("#by_gender_ration").removeClass("active");
					// $("#by_gender_female").removeClass("active");
					data_id = selected;
					check_data_level = 'dimension';
					// $scope.getDimensionMap();
			...
			$('#btn-show-gii').click(function() {
				// $("#dataset_definition").text("Gender Inequality Index "+ year);
				area_id = '9999';
				$('#gii_dimension_dropdown').val('gii').change();
				$scope.showChartDesc();
			});
	...
	'use strict';
	angular.module('baseApp')
	.controller('referencecontroller' ,["$scope", "$timeout", function ($scope, $timeout) {
...
(function () {
	...
	'use strict';
	angular.module('baseApp')
	.controller('settingsCtrl', ["$scope", "$translate", "$rootScope", function ($scope, $translate, $rootScope) {
